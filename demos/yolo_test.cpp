...
int main() {
  const std::string& image_path = "/home/hiaren/Projects/KuiperInfer/imgs/car.jpg";
  const std::string& param_path = "/home/hiaren/Projects/KuiperInfer/tmp/yolo/demo/yolov5s_batch8.pnnx.param";
  const std::string& weight_path = "/home/hiaren/Projects/KuiperInfer/tmp/yolo/demo/yolov5s_batch8.pnnx.bin";
